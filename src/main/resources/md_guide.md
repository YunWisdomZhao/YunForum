...
支持大部分标准的表情符号，可使用输入法直接输入，也可手动输入字符格式。欢迎通过快捷键 `Ctrl+/` 自动完成进行输入，并在个人设置中[设置常用表情](http://127.0.0.1:8080/settings/function)。
...
我们的编辑器支持很多快捷键，具体请参考 [键盘快捷键](http://127.0.0.1:8080/article/1474030007391)（或者按 `?` :smirk_cat:）