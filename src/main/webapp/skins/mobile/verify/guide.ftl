                ...
                <div class="verify-wrap">
                    ...
                    <div class="guide-tab">
                        ...
                        <div class="fn-none ft-center">
                            <br/>
                            <a href="https://github.com/YunWisdomZhao/BBS" target="_blank"><img src="${staticServePath}/images/sym-logo300.png" width="180px"></a> <br/> <br/><br/>
                        ...
                        <div class="fn-none list">
                            <ul>
                                <li>
                                    <a href="${servePath}/article/1546929099122">${getStartLabel}</a>
                                ...
                                <li>
                                    <a href="http://127.0.0.1:8080/article/1474030007391">${hotKeyLabel}</a>
                                    <span class="ft-gray">${hotKeyTipLabel}</span>
                                </li>
                                <li>
                                    <a href="http://127.0.0.1:8080/guide/markdown">Markdown ${tutorialLabel}</a>
